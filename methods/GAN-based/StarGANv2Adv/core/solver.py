...
class Solver(nn.Module):
    ...
    def train(self, loaders):
        ...
        for i in range(args.resume_iter, args.total_iters):
          ...
          # train the generator
          g_loss, g_losses_latent, s_trg_lat = compute_g_loss(nets, args, x_real, y_org, y_trg, z_trgs=[z_trg, z_trg2], masks=masks)
          self._reset_grad()
          g_loss.backward()
          ...
          g_loss, g_losses_ref, s_trg_ref = compute_g_loss(nets, args, x_real, y_org, y_trg, x_refs=[x_ref, None], masks=masks)
          self._reset_grad()
          g_loss.backward()
          optims.generator.step()
...
def compute_g_loss(nets, args, x_real, x_real2, flow, mask, y_org, y_trg, z_trgs=None, x_refs=None, masks=None):
