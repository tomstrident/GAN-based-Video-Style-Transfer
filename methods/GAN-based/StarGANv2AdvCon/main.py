...
from core.data_loader import get_loaderFC2
from sintel_dataset import getTestDatasetLoader
...
def main(args):
    ...
    if args.mode == 'train':
      ...
      train_loader, eval_loader = get_loaderFC2(args.data_dir, args.style_dir, args.temp_dir, args.batch_size, args.num_workers, args.num_domains, args.mode)
      ...
      solver.train([train_loader, test_loader])
        ...
        _, eval_loader = get_loaderFC2(args.data_dir, args.style_dir, args.temp_dir, args.batch_size, args.num_workers, args.num_domains, args.mode)
...
if __name__ == '__main__':
    ...
    # temporal loss !!!
    parser.add_argument('--lambda_tcl', type=float, default=100,  help='Weight for temporal consistency loss')
    ...
    parser.add_argument('--resume_iter', type=int, default=90000, help='Iterations to resume training/testing')
    ...
    # directory for style transfer
    #parser.add_argument('--data_dir', type=str, default='/home/tomstrident/datasets/FC2/DATAFiles/', help='Directory containing flows and masks')
    #parser.add_argument('--style_dir', type=str, default='/home/tomstrident/datasets/FC2/styled-files/', help='Directory containing style images')
    #parser.add_argument('--temp_dir', type=str, default='/home/tomstrident/datasets/FC2/styled-files3/', help='Directory containing temporal images')
    
    parser.add_argument('--data_dir', type=str, default="G:/Datasets/FC2/DATAFiles/", help='Directory containing flows and masks')
    parser.add_argument('--style_dir', type=str, default='G:/Datasets/FC2/styled-files/', help='Directory containing style images')
    parser.add_argument('--temp_dir', type=str, default='G:/Datasets/FC2/styled-files3/', help='Directory containing temporal images')
    ...
    parser.add_argument('--src_dir', type=str, default='assets/representative/celeba_hq/src', help='Directory containing input source images')
    parser.add_argument('--ref_dir', type=str, default='assets/representative/celeba_hq/ref', help='Directory containing input reference images')
    ...
    parser.add_argument('--out_dir', type=str, default='assets/representative/celeba_hq/src/female', help='output directory when aligning faces')
